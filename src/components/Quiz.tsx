                    ...
                    <div className="breakfast-callout">
                        ...
                        <p>
                            <Trans i18nKey="quiz.breakfast_recommendation" values={{ calories: results.breakfast }}>
                                Seu café da manhã ideal deve tener <strong>{results.breakfast} kcal</strong> para alcanzar esta meta.
                            </Trans>
                        </p>
                    </div>
                                ...
                                {history === 'first' ? (
                                    ...
                                    <div className="tips-step">
                                        <div className="tip-box">
                                            ...
                                            ) : failReason === 'motivacion' ? (
                                                <p>{t('quiz.step7_failure_tips.motivacion')}</p>
                                            ) : (
                                                <p>{t('quiz.step5_tips.' + mainGoal)}</p>
                                            )}
                                        </div>
